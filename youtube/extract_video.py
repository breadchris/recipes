...
class VideoExtractor:
    ...
    def extract_video_info(self, url: str) -> Tuple[Optional[Dict], Optional[str]]:
        ...
        Returns:
            Dictionary with video information (title, description, caption URLs)

        Note: This does NOT cache video metadata because caption URLs expire.
              Only the final VTT transcripts are cached.
        """
        ...
        try:
            with yt_dlp.YoutubeDL(self.ydl_opts) as ydl:
                # Get video info - always fetch fresh to get valid caption URLs

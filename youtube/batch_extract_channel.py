...
def get_channel_videos(channel_handle: str, days_back: int = 180):
    """
    Get video IDs from cached channel data, filtered by upload date.
...
def main():
    ...
    videos = get_channel_videos(args.channel, args.days)
